...
<div class="offcanvas offcanvas-end mobile-menu" tabindex="-1" id="headerMenu" aria-label="Men&uacute; principal">
    ...
    <div class="offcanvas-body mobile-menu-body">
        ...
        <a href="<?= base_url('notificaciones') ?>" class="mobile-menu-link mobile-menu-link--with-badge <?= tabActive('notificaciones', $current) ?>" <?= $current === 'notificaciones' ? 'aria-current="page"' : '' ?>>
            ...
            <span class="badge bg-danger d-none" id="mobile-notif-badge" aria-label="Notificaciones sin leer">0</span>
        </a>
...
(function() {
    ...
    function getAccessibilityLabel(count) {
    ...
    function refreshNotificationCount() {
        ...
        fetch(counterUrl, { credentials: 'same-origin' })
            ...
            .then(function(data) {
                ...
                var label = getAccessibilityLabel(count);
                ...
                if (topbarLink) {
                    topbarLink.setAttribute('aria-label', label);
                }
            })
            .catch(function() {})
