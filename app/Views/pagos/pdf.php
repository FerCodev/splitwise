...
<head>
    ...
    <style>
        ...
        .summary { margin-bottom: 14px; padding: 10px; background: #f0fdf4; border-radius: 4px; }
...
<body>
    ...
    <div class="summary">
        <strong>Total filtrado: <?= moneda($total) ?></strong><br>
        <span class="muted"><?= count($pagos) ?> pago(s) exportado(s)</span>
    </div>
    <table>
        <thead><tr><th>Fecha</th><th>Descripcion</th><th>Grupo</th><th>Pago</th><th>Recibio</th><th class="num">Monto</th></tr></thead>
        <tbody>
            <?php foreach ($pagos as $pago): ?>
                <tr>
                    ...
                    <td class="num"><?= moneda($pago['monto']) ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
