...
<div class="container catalog-page mt-3 mt-md-4 pb-4">
    ...
    <section class="catalog-section">
        ...
        <div class="catalog-grid">
            ...
            <article class="catalog-variant"><div class="catalog-variant-meta"><span>Credencial</span><small>Mini tarjeta bancaria</small></div><div class="catalog-bank-card"><div class="catalog-card-top"><span>Banco Galicia</span><div class="catalog-row"><span class="badge bg-light text-dark">Activo</span><button type="button" class="catalog-bank-fav medio-fav-active" aria-label="Quitar favorito"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" viewBox="0 0 16 16"><path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/></svg></button></div></div><div class="catalog-bank-number">0000 3100 1234 5678</div><div class="catalog-card-top"><small>Fernando</small><button type="button" class="copiar-icon-btn" aria-label="Copiar CBU"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16"><path d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z"/><path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3z"/></svg></button></div></div></article>
        </div>
    </section>
</div>
