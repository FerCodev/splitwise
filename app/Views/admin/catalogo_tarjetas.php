...
<div class="container catalog-page mt-3 mt-md-4 pb-4">
    <div class="catalog-hero mb-4">
        ...
        <span class="badge bg-primary-subtle text-primary catalog-count">25 variantes</span>
    </div>
