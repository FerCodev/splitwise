...
<div class="container catalog-page mt-3 mt-md-4 pb-4">
    ...
    <section class="catalog-section">
        ...
        <div class="catalog-grid">
            ...
            <article class="catalog-variant"><div class="catalog-variant-meta"><span>Tablero de zonas</span><small>Verde, amarillo y rojo</small></div><div class="catalog-gauge-zones"><div class="catalog-card-top"><div><span class="text-muted small d-block">Vos pagaste</span><strong><?= moneda(860000) ?></strong></div><b>55%</b></div><div class="catalog-gauge-zone-track"><span class="catalog-zone-low"></span><span class="catalog-zone-mid"></span><span class="catalog-zone-high"></span><i style="left: 55%;"></i></div><div class="catalog-gauge-zone-scale"><span>0</span><span><?= moneda(521241) ?></span><span><?= moneda(1042482) ?></span><span><?= moneda(1563723) ?></span></div><div class="catalog-gauge-zone-note"><span class="status-dot status-dot-active"></span><small>El color indica en qu&eacute; tramo cae tu aporte.</small></div></div></article>
            <article class="catalog-variant"><div class="catalog-variant-meta"><span>Escala vertical</span><small>Lectura tipo medidor</small></div><div class="catalog-gauge-vertical"><div><span class="text-muted small">Tu aporte</span><strong>55%</strong><b><?= moneda(860000) ?></b></div><div class="catalog-gauge-vertical-meter"><span style="height: 55%;"></span><i style="bottom: 55%;"></i></div><div class="catalog-gauge-vertical-scale"><span><?= moneda(1563723) ?></span><span><?= moneda(1172792) ?></span><span><?= moneda(781862) ?></span><span><?= moneda(390931) ?></span><span><?= moneda(0) ?></span></div></div></article>
            <article class="catalog-variant"><div class="catalog-variant-meta"><span>Regla financiera</span><small>Marcas num&eacute;ricas densas</small></div><div class="catalog-gauge-ruler"><div class="catalog-card-top"><span class="text-muted small">Tu posici&oacute;n en la escala</span><b class="text-primary">55%</b></div><div class="catalog-gauge-ruler-track"><span style="width: 55%;"></span><i style="left: 55%;"></i></div><div class="catalog-gauge-ruler-marks"><span><?= moneda(0) ?></span><span><?= moneda(312745) ?></span><span><?= moneda(625489) ?></span><span><?= moneda(938234) ?></span><span><?= moneda(1250978) ?></span><span><?= moneda(1563723) ?></span></div><div class="catalog-gauge-ruler-value">Vos pagaste <?= moneda(860000) ?> de <?= moneda(1563723) ?></div></div></article>
        </div>
    </section>
