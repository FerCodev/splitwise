                                    ...
                                    <div class="flex-grow-1 min-width-0">
                                        <div class="d-flex justify-content-between align-items-start mb-1">
                                            <div class="d-flex align-items-center gap-2 min-width-0">
                                                <span class="fw-semibold text-truncate"><?= esc($m['nombre'] ?? $m['tipo']) ?></span>
                                                <span class="badge <?= $m['activo'] ? 'bg-success' : 'bg-danger' ?> flex-shrink-0"><?= $m['activo'] ? 'Activo' : 'Inactivo' ?></span>
                                            </div>
                                            <?php if (!$m['favorito']): ?>
                                                <form action="<?= base_url('mis-medios-de-cobro/' . $m['id'] . '/favorito') ?>" method="post" class="d-inline flex-shrink-0 ms-2">
                                                    <?= csrf_field() ?>
                                                    <button type="submit" class="medio-fav-btn" aria-label="Marcar como favorito" title="Marcar como favorito">
                                            ...
                                            <?php else: ?>
                                                <form action="<?= base_url('mis-medios-de-cobro/' . $m['id'] . '/favorito') ?>" method="post" class="d-inline flex-shrink-0 ms-2">
                                                    <?= csrf_field() ?>
                                                    <button type="submit" class="medio-fav-btn medio-fav-active" aria-label="Quitar favorito" title="Quitar favorito">
                                        ...
                                        <div class="small text-muted mb-2">
                                            <?php if ($m['titular']): ?>
                                                <div class="d-flex align-items-center"><span class="fw-medium me-1">Titular:</span> <?= esc($m['titular']) ?></div>
                                            <?php endif; ?>
                                            <?php if ($m['alias']): ?>
                                                <div class="d-flex align-items-center gap-1">
                                                    <span class="fw-medium">Alias:</span> <span class="text-truncate"><?= esc($m['alias']) ?></span>
                                            ...
                                            <?php if ($m['cbu_cvu']): ?>
                                                <div class="d-flex align-items-center gap-1">
                                                    <span class="fw-medium">CBU/CVU:</span> <span class="text-truncate"><?= esc($m['cbu_cvu']) ?></span>
