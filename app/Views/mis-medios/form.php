...
<?= view('partials/_navbar', ['pageTitle' => isset($medio) ? 'Editar medio' : 'Nuevo medio']) ?>
    ...
    <div class="container mt-3 mt-md-4">
        <h2 class="mb-3 d-none d-md-block"><?= isset($medio) ? 'Editar medio de cobro' : 'Nuevo medio de cobro' ?></h2>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?= isset($medio) ? base_url('mis-medios-de-cobro/' . $medio['id']) : base_url('mis-medios-de-cobro') ?>" method="post">
                    ...
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Nombre <small class="text-muted">(ej: Mercado Pago, Santander)</small></label>
                    ...
                    <div class="mb-3">
                        <label for="cbu_cvu" class="form-label">CBU/CVU <small class="text-muted">(requerido si no hay alias)</small></label>
                    ...
                    <div class="mb-3">
                        <label for="alias" class="form-label">Alias <small class="text-muted">(requerido si no hay CBU/CVU)</small></label>
                    ...
                    <div class="mb-3">
                        <label for="banco" class="form-label">Banco <small class="text-muted">(opcional)</small></label>
                    ...
                    <div class="mb-3">
                        <label for="payment_link" class="form-label">Link de pago <small class="text-muted">(opcional)</small></label>
