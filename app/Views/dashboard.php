                                    ...
                                    <div class="list-group-item">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <br>
                                                <span class="text-muted small"><?= esc($gasto['grupo_nombre']) ?> &middot; <?= esc($gasto['pagador_nombre']) ?> &middot; <?= date('d/m/Y', strtotime($gasto['fecha'])) ?> &middot; <span class="badge bg-light text-dark"><?= esc($gasto['categoria_nombre'] ?? 'Otros') ?></span></span>
                                            </div>
