        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div style="text-align:center;margin-bottom:32px;">
                    ...
                    <p style="color:var(--muted);font-size:14px;margin:4px 0 0;">Recuperar contrase&ntilde;a</p>
                </div>
                <div class="card">
                    <div class="card-body" style="padding:24px;">
                        ...
                        <div style="text-align:center;margin-top:16px;">
                            <a href="<?= base_url('login') ?>" style="font-size:13px;color:var(--muted);">Volver al inicio de sesi&oacute;n</a>
                        </div>
                    </div>
                </div>
            </div>
