                        ...
                        <div class="mt-3">
                            ...
                            <select name="persona_id" class="form-select">
                                ...
                                <?php foreach ($miembros as $miembro): ?>
                                    <option value="<?= $miembro['user_id'] ?>" <?= ($movimientoFilters['persona_id'] ?? '') == $miembro['user_id'] ? 'selected' : '' ?>><?= esc($miembro['name']) ?><?= !empty($miembro['username']) ? ' (@' . esc($miembro['username']) . ')' : '' ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="mt-3">
