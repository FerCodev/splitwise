...
$routes->get('/categorias', 'Categorias::index', ['filter' => 'auth']);
$routes->get('/categorias/nuevo', 'Categorias::new', ['filter' => 'auth']);
$routes->post('/categorias', 'Categorias::create', ['filter' => 'auth']);
$routes->get('/categorias/(:num)/editar', 'Categorias::edit/$1', ['filter' => 'auth']);
$routes->put('/categorias/(:num)', 'Categorias::update/$1', ['filter' => 'auth']);
$routes->post('/categorias/(:num)/toggle', 'Categorias::toggle/$1', ['filter' => 'auth']);
$routes->delete('/categorias/(:num)', 'Categorias::delete/$1', ['filter' => 'auth']);
