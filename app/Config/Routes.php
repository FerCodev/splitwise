...
$routes->get('/invitaciones/registro/(:any)', 'Invitaciones::registro/$1');
$routes->post('/invitaciones/registro/(:any)', 'Invitaciones::crearCuenta/$1');
...
$routes->get('/usuarios/(:num)/perfil', 'Perfil::visitante/$1', ['filter' => 'auth']);
...
$routes->get('/amigos', 'Amigos::index', ['filter' => 'auth']);
$routes->post('/amigos/enviar', 'Amigos::enviar', ['filter' => 'auth']);
$routes->post('/amigos/(:num)/aceptar', 'Amigos::aceptar/$1', ['filter' => 'auth']);
$routes->post('/amigos/(:num)/rechazar', 'Amigos::rechazar/$1', ['filter' => 'auth']);
$routes->post('/amigos/(:num)/cancelar', 'Amigos::cancelar/$1', ['filter' => 'auth']);
$routes->post('/amigos/(:num)/eliminar', 'Amigos::eliminar/$1', ['filter' => 'auth']);
...
$routes->post('/grupos/(:num)/invitaciones', 'Grupos::invitarPorEmail/$1', ['filter' => 'auth']);
$routes->post('/grupos/(:num)/invitaciones/(:num)/reenviar', 'Grupos::reenviarInvitacion/$1/$2', ['filter' => 'auth']);
$routes->post('/grupos/(:num)/invitaciones/(:num)/cancelar', 'Grupos::cancelarInvitacion/$1/$2', ['filter' => 'auth']);
...
$routes->post('/grupos/(:num)/saldar-deuda', 'Grupos::saldarDeuda/$1', ['filter' => 'auth']);
