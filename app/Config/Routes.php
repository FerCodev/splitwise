...
$routes->get('/password/olvidada', 'PasswordReset::olvidada');
$routes->post('/password/olvidada', 'PasswordReset::enviarEnlace');
$routes->get('/password/reset/(:any)', 'PasswordReset::reset/$1');
$routes->post('/password/reset/(:any)', 'PasswordReset::cambiarPassword');
