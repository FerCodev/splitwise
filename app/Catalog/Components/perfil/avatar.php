...
return [
    ...
    'variants' => [
        ...
        ['key' => 'sizes', 'name' => 'Tama?os', 'hint' => '24, 40 y 72 px.', 'render' => static fn () => view('components/avatar', ['userId' => 3, 'name' => 'Mar?a', 'avatarFilename' => null, 'avatarUpdatedAt' => null, 'size' => 24]) . ' ' . view('components/avatar', ['userId' => 3, 'name' => 'Mar?a', 'avatarFilename' => null, 'avatarUpdatedAt' => null, 'size' => 40]) . ' ' . view('components/avatar', ['userId' => 3, 'name' => 'Mar?a', 'avatarFilename' => null, 'avatarUpdatedAt' => null, 'size' => 72])],
    ],
];
